...
std::string globals::manrst::option("\n**%1%** %2%\n");

std::string globals::manrst::header("%1% %2%\n###########################\n\n");

std::string globals::manrst::name(
    "\nNAME\n****\n"
    "%1% - Part of the VOTCA package\n"
    "For more info please visit %2%\n\n");

std::string globals::manrst::authors(
    "\n\nAUTHORS\n*******\n"
    "Written and maintained by the VOTCA Development Team <%1%>\n");

std::string globals::manrst::copyright(
    "\nCOPYRIGHT\n*********\n"
    "Copyright 2009\\-2020 The VOTCA Development Team (%1%).\n"
    "Licensed under the Apache License, Version 2.0 (the \"License\") "
    "you may not use this file except in compliance with the License. "
...
std::string globals::manrst::synopsis(
    "\nSYNOPSIS\n********\n"
    "**%1%** [*OPTION*] [*ARGUMENT*]\n");

std::string globals::manrst::description(
    "\nDESCRIPTION\n***********\n"
    "%1%\n");

std::string globals::manrst::options("\nOPTIONS\n*******\n");
